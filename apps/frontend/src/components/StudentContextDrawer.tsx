        ...
        {student ? (
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
            ...
            <div className="drawer-body scroller">
              ...
              {/* ── Overview — Structured in Exact Same Preference Order ── */}
              {activeTab === 'overview' && (
                <div
                ...
                >
                  {/* 1. Registration & Intake Details */}
                  <div>
                    <span className="drawer-section-label">Registration & Intake Details</span>
                    <div className="drawer-info-grid">
                      ...
                      <div className="drawer-info-item">
                        ...
                        <span className="drawer-info-value">{student.details?.form_no || student.details?.['Form No'] || student.details?.form_number || '—'}</span>
                      </div>
                      <div className="drawer-info-item">
                      ...
                      <div className="drawer-info-item">
                        <span className="drawer-info-label">Walk-in Branch</span>
                      ...
                      <div className="drawer-info-item">
                        ...
                        <span className="drawer-info-value">{student.details?.know_about_us || student.details?.['How Did You Know About Us'] || student.details?.['How Did You Know Us'] || '—'}</span>
                      </div>
                      <div className="drawer-info-item">
                        <span className="drawer-info-label">Referrer Name</span>
                        <span className="drawer-info-value">{student.details?.referrer_name || student.details?.['Referrer Name'] || '—'}</span>
                      </div>
                      <div className="drawer-info-item">
                        <span className="drawer-info-label">Added Time</span>
                        <span className="drawer-info-value">{student.details?.added_time || student.details?.['Added Time'] || '—'}</span>
                      </div>
                      <div className="drawer-info-item">
                        <span className="drawer-info-label">Added Email ID</span>
                        <span className="drawer-info-value">{student.details?.added_email_id || student.details?.['Added Email ID'] || '—'}</span>
                      </div>
                      <div className="drawer-info-item">
                        <span className="drawer-info-label">IP Address</span>
                        <span className="drawer-info-value">{student.details?.ip || student.details?.['IP Address'] || '—'}</span>
                      </div>
                      {student.remarks && (
                        <div className="drawer-info-item" style={{ gridColumn: '1 / -1' }}>
                          <span className="drawer-info-label">Intake Remarks</span>
                          <span className="drawer-info-value" style={{ fontStyle: 'italic', lineHeight: 1.5 }}>{student.remarks}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  {/* 2. Personal Details */}
                  <div>
                    <span className="drawer-section-label">Personal Details</span>
                    <div className="drawer-info-grid">
                      <div className="drawer-info-item">
                        <span className="drawer-info-label">Student Name</span>
                        <span className="drawer-info-value" style={{ fontWeight: 800 }}>{student.name || '—'}</span>
                      </div>
                      <div className="drawer-info-item">
                      ...
                      <div className="drawer-info-item">
                        ...
                        <span className="drawer-info-value" style={{ fontFamily: 'var(--font-mono)' }}>
                          {student.details?.parent_phone || student.details?.['Parent Phone'] || student.details?.['Parent Number'] || '—'}
                        </span>
                      </div>
                      <div className="drawer-info-item">
                      ...
                      <div className="drawer-info-item">
                        ...
                        <span className="drawer-info-value">{student.details?.gender || student.details?.['Gender'] || '—'}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="drawer-info-grid">
                      <div className="drawer-info-item" style={{ gridColumn: '1 / -1' }}>
                        <span className="drawer-info-label">Educational Qualification</span>
                        <span className="drawer-info-value">
                          {student.details?.qualification || student.details?.['Educational Qualification'] || '—'}
                        </span>
                      </div>
                      <div className="drawer-info-item" style={{ gridColumn: '1 / -1' }}>
                        <span className="drawer-info-label">Institution Name</span>
                        <span className="drawer-info-value">
                          {student.details?.college_name || student.details?.['Institution Name'] || '—'}
                        </span>
                      </div>
                      <div className="drawer-info-item">
                        <span className="drawer-info-label">Year of Passout</span>
                        <span className="drawer-info-value">
                      ...
                      <div className="drawer-info-item">
                        ...
                        <span className="drawer-info-value">{student.details?.ssc_percentage || student.details?.['10th %'] || student.details?.['10th_Percent'] || '—'}</span>
                      </div>
                      <div className="drawer-info-item">
                        <span className="drawer-info-label">Intermediate %</span>
                        <span className="drawer-info-value">{student.details?.inter_percentage || student.details?.['Intermediate %'] || student.details?.['Intermediate_Percent'] || '—'}</span>
                      </div>
                      <div className="drawer-info-item">
                        <span className="drawer-info-label">B.Tech / Degree %</span>
                        <span className="drawer-info-value">{student.details?.degree_percentage || student.details?.['B.Tech/Degree %'] || student.details?.['B.Tech / Degree %'] || '—'}</span>
                      </div>
                      <div className="drawer-info-item">
                        <span className="drawer-info-label">Post Graduation %</span>
                        <span className="drawer-info-value">{student.details?.pg_percentage || student.details?.['Post Graduation %'] || '—'}</span>
                      </div>
                    </div>
                  </div>

                  {/* 4. Training & Course Preferences */}
                  <div>
                    <span className="drawer-section-label">Training & Course Preferences</span>
                    <div className="drawer-info-grid">
                      <div className="drawer-info-item">
                        <span className="drawer-info-label">Preferred Course</span>
                        <span className="drawer-info-value" style={{ fontWeight: 700 }}>{student.course || '—'}</span>
                      </div>
                      <div className="drawer-info-item">
                      ...
                      <div className="drawer-info-item" style={{ gridColumn: '1 / -1' }}>
                        <span className="drawer-info-label">Previous Training Institute</span>
